...
namespace BlazorCashier.Server.Migrations
{
    ...
    [Migration("20200421120747_EditModelTypes")]
    partial class EditModelTypes
    {
            ...
            modelBuilder.Entity("BlazorCashier.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d257efc0-76fb-47f0-9ee1-fea8767cb04e",
                            Code = "LB",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 21, 12, 7, 46, 290, DateTimeKind.Unspecified).AddTicks(3257), new TimeSpan(0, 0, 0, 0, 0)),
                            CultureCode = "ar-LB",
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 21, 12, 7, 46, 290, DateTimeKind.Unspecified).AddTicks(3286), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Lebanon"
                        });
                });
            ...
            modelBuilder.Entity("BlazorCashier.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "20023616-9487-4c1a-aae9-c95f6cc918b2",
                            Code = "USD",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 21, 12, 7, 46, 292, DateTimeKind.Unspecified).AddTicks(1605), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 21, 12, 7, 46, 292, DateTimeKind.Unspecified).AddTicks(1624), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Dollar",
                            Symbol = "$"
                        });
                });
