...
namespace BlazorCashier.Server.Migrations
{
    ...
    [Migration("20200423062219_AlterColumnType")]
            ...
            modelBuilder.Entity("BlazorCashier.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "8b653f55-60d4-4b2d-a8dc-2e9c2b8dea57",
                            Code = "LB",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 23, 6, 22, 18, 860, DateTimeKind.Unspecified).AddTicks(8000), new TimeSpan(0, 0, 0, 0, 0)),
                            CultureCode = "ar-LB",
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 23, 6, 22, 18, 860, DateTimeKind.Unspecified).AddTicks(8025), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Lebanon"
                        });
                });
            ...
            modelBuilder.Entity("BlazorCashier.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "936b2aee-7ac7-4c71-8eb6-21fc33f95e69",
                            Code = "USD",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 23, 6, 22, 18, 862, DateTimeKind.Unspecified).AddTicks(2690), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 23, 6, 22, 18, 862, DateTimeKind.Unspecified).AddTicks(2706), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Dollar",
                            Symbol = "$"
                        });
                });
