...
namespace BlazorCashier.Server.Migrations
{
    ...
    [Migration("20200419185058_EditCountryColumnName")]
    partial class EditCountryColumnName
    {
            ...
            modelBuilder.Entity("BlazorCashier.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7cd2931e-1927-4a90-b8d7-c143ec9f47af",
                            Code = "LB",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 19, 18, 50, 57, 533, DateTimeKind.Unspecified).AddTicks(4528), new TimeSpan(0, 0, 0, 0, 0)),
                            CultureCode = "ar-LB",
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 19, 18, 50, 57, 533, DateTimeKind.Unspecified).AddTicks(4552), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Lebanon"
                        });
                });
            ...
            modelBuilder.Entity("BlazorCashier.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f9703357-0fe2-4b83-9aac-3f98b6e4e952",
                            Code = "USD",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 19, 18, 50, 57, 534, DateTimeKind.Unspecified).AddTicks(9143), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 19, 18, 50, 57, 534, DateTimeKind.Unspecified).AddTicks(9154), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Dollar",
                            Symbol = "$"
                        });
                });
