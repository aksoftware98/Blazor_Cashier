...
namespace BlazorCashier.Server.Migrations
{
    ...
    [Migration("20200427120030_EditInvoiceItemTable")]
    partial class EditInvoiceItemTable
    {
            ...
            modelBuilder.Entity("BlazorCashier.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "69c4dd5e-c804-49ad-9216-c7f8b9a20d33",
                            Code = "LB",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 27, 12, 0, 29, 861, DateTimeKind.Unspecified).AddTicks(374), new TimeSpan(0, 0, 0, 0, 0)),
                            CultureCode = "ar-LB",
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 27, 12, 0, 29, 861, DateTimeKind.Unspecified).AddTicks(396), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Lebanon"
                        });
                });
            ...
            modelBuilder.Entity("BlazorCashier.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "e5909d88-be72-462c-ad68-47ac448d20a6",
                            Code = "USD",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 27, 12, 0, 29, 862, DateTimeKind.Unspecified).AddTicks(5429), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 27, 12, 0, 29, 862, DateTimeKind.Unspecified).AddTicks(5443), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Dollar",
                            Symbol = "$"
                        });
                });
