...
namespace BlazorCashier.Server.Migrations
{
    ...
    [Migration("20200421144951_UpdateOrganization")]
            ...
            modelBuilder.Entity("BlazorCashier.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "42d0f5f0-f86f-48c2-9c15-b1a9f0b2ded3",
                            Code = "LB",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 21, 14, 49, 50, 801, DateTimeKind.Unspecified).AddTicks(6938), new TimeSpan(0, 0, 0, 0, 0)),
                            CultureCode = "ar-LB",
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 21, 14, 49, 50, 801, DateTimeKind.Unspecified).AddTicks(6967), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Lebanon"
                        });
                });
            ...
            modelBuilder.Entity("BlazorCashier.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "dcedbfad-f2ef-43a0-9829-af4462108bf3",
                            Code = "USD",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 21, 14, 49, 50, 803, DateTimeKind.Unspecified).AddTicks(2836), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 21, 14, 49, 50, 803, DateTimeKind.Unspecified).AddTicks(2850), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Dollar",
                            Symbol = "$"
                        });
                });
