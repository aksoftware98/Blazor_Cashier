...
namespace BlazorCashier.Server.Migrations
{
    ...
    [Migration("20200418092738_InitDatabase")]
            ...
            modelBuilder.Entity("BlazorCashier.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "93e48ee8-fb66-40fb-be8c-9d27e4d1948d",
                            Code = "LB",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 18, 9, 27, 37, 821, DateTimeKind.Unspecified).AddTicks(1644), new TimeSpan(0, 0, 0, 0, 0)),
                            CultureCode = "ar-LB",
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 18, 9, 27, 37, 821, DateTimeKind.Unspecified).AddTicks(1669), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Lebanon"
                        });
                });
            ...
            modelBuilder.Entity("BlazorCashier.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "63ca1492-e03a-4aab-8fbd-e08e7d8a0fd6",
                            Code = "USD",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 4, 18, 9, 27, 37, 823, DateTimeKind.Unspecified).AddTicks(6275), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedDate = new DateTimeOffset(new DateTime(2020, 4, 18, 9, 27, 37, 823, DateTimeKind.Unspecified).AddTicks(6286), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Dollar",
                            Symbol = "$"
                        });
                });
